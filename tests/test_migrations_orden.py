...
def test_migrations_tienen_prefijo_numerico_unico_y_ordenado():
    ...
    assert nombres == [
        ...
        "018_clientes_cuenta_corriente_movimientos.sql",
        "019_ventas_comprobantes.sql",
        "020_catalogos_fiscales_unidades_bonificaciones.sql",
        "021_catalogo_fiscal_tipos_comprobante.sql",
        "022_ventas_comprobantes_tipo_fiscal.sql",
        "023_ventas_comprobantes_letra_clase_c.sql",
        "024_ventas_detalle_unidad_bonificacion.sql",
        "025_ventas_comprobantes_asociaciones.sql",
        "026_asientos_contables_tipo_venta.sql",
        "027_asientos_contables_tipo_cobranza_caja.sql",
        "028_clientes_cobranzas_movimientos_caja.sql",
        "029_cobranzas_caja_restricciones_unicidad.sql",
        "030_caja_intenciones.sql",
    ]
    assert prefijos == [
        "001",
        "002",
