CREATE TABLE articulos_venta (
    ...
    precio_unitario_sugerido_1000000 INTEGER NOT NULL DEFAULT 0,
    ...
    CONSTRAINT ck_articulos_venta_precio_sugerido_entero_no_negativo
        CHECK (
            typeof(precio_unitario_sugerido_1000000) = 'integer'
            AND precio_unitario_sugerido_1000000 >= 0
        ),
