...
ALTER TABLE asientos_contables RENAME TO asientos_contables_legacy_027;
...
CREATE TABLE asientos_contables (
    ...
    CHECK (tipo IN ('MANUAL', 'AJUSTE', 'APERTURA', 'CIERRE', 'REVERSION', 'VENTA', 'COBRANZA', 'CAJA')),
...
SELECT
    ...
    anulado_en,
    asiento_reversion_id
FROM asientos_contables_legacy_027;

DROP TABLE asientos_contables_legacy_027;
